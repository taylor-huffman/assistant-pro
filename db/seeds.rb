...
# account1 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account2 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account3 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account4 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account5 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account6 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account7 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account8 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account9 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account10 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account11 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)
# account12 = Account.new(name: Faker::Name.name, email: Faker::Internet.email, password_digest: Faker::Internet.password, address: Faker::Address.full_address, phone: Faker::PhoneNumber.phone_number)

# account1.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/alex.png')),
#     filename: 'alex.png'
# )
# account2.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/andrew-headshot-1.png')),
#     filename: 'andrew-headshot-1.png'
# )
# account3.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/angela-headshot-1.png')),
#     filename: 'angela-headshot-1.png'
# )
# account4.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/bri.png')),
#     filename: 'bri.png'
# )
# account5.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/dave-headshot-1.png')),
#     filename: 'dave-headshot-1.png'
# )
# account6.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/elizabeth.png')),
#     filename: 'elizabeth.png'
# )
# account7.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/jon-photo.png')),
#     filename: 'jon-photo.png'
# )
# account8.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/manuel-headshot-1.png')),
#     filename: 'manuel-headshot-1.png'
# )
# account9.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/mario.png')),
#     filename: 'mario.png'
# )
# account10.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/taylor-photo.png')),
#     filename: 'taylor-photo.png'
# )
# account11.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/ted-headshot-1.png')),
#     filename: 'ted-headshot-1.png'
# )
# account12.image.attach(
#     io:  File.open(File.join(Rails.root,'client/src/media/seeds/theressa-headshot-1.png')),
#     filename: 'theressa-headshot-1.png'
# )
